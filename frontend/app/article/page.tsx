    ...
    return (
      <main className={'w-full min-h-screen'}>
        <section className={'w-full h-120 relative overflow-hidden bg-secondary/50 flex flex-col items-center justify-center'}>
          ...
          >
            <h1 className='text-4xl'>Omlouváme se, ale daný článek jsme nenašli...</h1>
            <Icon icon="mage:robot-sad" width="64" height="64" />
            <span className='text-2xl mt-8'>Myslíte že se jedná o chybu? Zkuste nás kontaktovat.</span>
            <span className='text-accent break-keep text-2xl'>support@jakofakt.cz</span>
          </div>
        </section>
      </main>
    );
